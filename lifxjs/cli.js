...
var alertFunction = function(){
	if(alertIsOn){
		if(alertIsBright){
			...
			//lx.sendToAll(packet.setDimRelative(100,1));
			
			//lx.sendToAll(packet.setDimRelative(500,1));
			//lx.sendToAll(packet.setDimRelative(600,1));
			console.log("Off");
		}
...
stdin.on('data', function (key) {
	...
	switch (key[0]) {
		...
		case 0x6e: // n
			...
			console.log("RedAlertOn");
			
			alertIsOn = true;
			// BB8 7D0
			//lx.lightsColour(hue,    saturation, luminance, whiteColour, fadeTime);
			//lx.lightsColour(0x0000, 0xffff, 0x8000, 0, 2000);
			break;
				case 0x6e: // n
		case 0x6f: // o
			console.log("Doing my own thing");
			...
			alertIsOn = false;
			lx.lightsColour(0x0000, 0x0000, 0x8000, 0x0af0, 0x0513);
			//lx.lightsColour(0x0000, 0xffff, 0x1000, 0, 2000);
			break;

		case 0x73: //s
		console.log("Shields UP!");
		lx.lightsColour(39072, 0xffff, 0x8000, 0, 0);
		setTimeout(function(){
			lx.lightsColour(0x0000, 0x0000, 0x8000, 0x0af0, 0);
		},200);
		//lx.sendToAll(packet.setDimRelative(100,1));
